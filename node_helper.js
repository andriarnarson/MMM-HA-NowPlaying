...
module.exports = NodeHelper.create({
    ...
    getHomeAssistantData: function(config) {
        ...
        console.log("MMM-HA-NowPlaying: Config:", config);
                ...
                if (res.statusCode === 200) {
                    try {
                        ...
                        if (jsonData.attributes) {
                            ...
                            console.log("MMM-HA-NowPlaying: Media artist:", jsonData.attributes.media_artist || "None");
                            console.log("MMM-HA-NowPlaying: Media duration:", jsonData.attributes.media_duration || "None");
                        }
